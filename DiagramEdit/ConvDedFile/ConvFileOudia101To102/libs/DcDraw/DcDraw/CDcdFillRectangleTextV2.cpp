...
//@name 下請関数
// --------------------------------
Ou<CGdiHFontHolder> CDcdFillRectangleTextV2::CreateVFont( 
...
int CDcdFillRectangleTextV2::StringToMojiretsuyouso( 
		const string& aStr , 
		Mup<CMojiretsuyouso>* pCMojiretsuyousoCont ) 
{
	int iRv = 0 ;
	...
	{
		LogMsgL( 3 , "CDcdFillRectangleTextV2::StringToMojiretsuyouso"
		...
		CMojiretsuyouso*	pCMojiretsuyousoPrev = NULL ;
		if ( pCMojiretsuyousoCont->size() > 0 )
		{
			pCMojiretsuyousoPrev = pCMojiretsuyousoCont->getp( INT_MAX ) ;
		}
		//strChar = 今回の文字。
			...
			idxMojiretsuyouso ++ )
	{
		...
		{
			pCMojiretsuyousoPrev = pCMojiretsuyousoCont->getp( idxMojiretsuyouso - 1 ) ;
		}
...
int CDcdFillRectangleTextV2::MojiretsuyousoToMojiretsuyousoPlace( 
		IfDcdTarget* pIfDcdTarget ,
		const CdFontProp& fontHorizontal ,
		const Mu<CMojiretsuyouso>* pCMojiretsuyousoCont ,
		Mui<CMojiretsuyousoPlace>* pCMojiretsuyousoPlaceCont ) 
{
	int iRv = 0 ;
	...
	//	フォントを作成
	// --------------------------------
	Ou<CGdiHFontHolder> pfontVertical = CreateVFont( pIfDcdTarget , fontHorizontal ) ;
...
bool CDcdFillRectangleTextV2::DcDrawMojiretsuyousoPlace( 
		...
		const Mu<CMojiretsuyousoPlace>* pCMojiretsuyousoPlaceCont ) 
{
	bool bRv = false ;
...
bool CDcdFillRectangleTextV2::DcDraw( IfDcdTarget* pIfDcdTarget ) 
{
...

	{
		CaDcdTargetItemPosition aCaDcdTargetItemPosition( 
			pIfDcdTarget , 
			aCdDcdZoneXy ) ;
		CMup_deque<CMojiretsuyouso> aCMojiretsuyousoCont ;
		StringToMojiretsuyouso( m_strText , &aCMojiretsuyousoCont ) ;
		CMup_deque<CMojiretsuyousoPlace> aCMojiretsuyousoPlaceCont ;
