...
// ****************************************************************
//	CRfEditCmd_Rosen.h
//	$Id: CRfEditCmd_Rosen.h 149 2013-02-02 07:17:32Z okm $
// ****************************************************************
*/
/** @file */
#ifndef  CRfEditCmd_Rosen_h
#define  CRfEditCmd_Rosen_h
...
/**
 * @brief
  CentDedRosen オブジェクト全体を上書きする編集動作です。

 */
class CRfEditCmd_Rosen : 
	public CRfEditCmd
{
private:
	// ********************************
...
public:
	...
	/**
	  @param value [in]
	 	新しい CentDedRosen の内容を指定してください。
	 */
	CRfEditCmd_Rosen( const CentDedRosen& value ) ;
	virtual ~CRfEditCmd_Rosen() ;
...
public:
	// ********************************
	///@name CRfEditCmd_Rosen-属性
	// ********************************
	///@{
	CentDedRosen	getValue()const{	return m_Value ;};
	///@}
