...
*/
// ****************************************************************
// $Id: CdRessyasyubetsuXColSpec.h 179 2014-05-05 13:50:33Z okm $
// ****************************************************************
/** @file */
#pragma once
#ifndef ViewRessyasyubetsu_CdRessyasyubetsuXColSpec_h
#define ViewRessyasyubetsu_CdRessyasyubetsuXColSpec_h

namespace ViewRessyasyubetsu{ namespace RessyasyubetsuColSpec{
/**
@brief
  列車種別ビューの CWndDcdGridRessyasyubetsu において、グリッドのX列に表示
  すべき内容を記述した、単純データクラスです。

  この値は NULL 状態を持ちます。
*/
class CdRessyasyubetsuXColSpec
{
public:
	// ********************************
	//	インナータイプ
	...
	enum EColumnType
	{
		...
		ColumnType_LineNo = 0 ,
		/**	種別名 */
		ColumnType_Syubetsumei  ,
		/**	略称 */
		ColumnType_Ryakusyou ,
		/**	線スタイル */
		ColumnType_DiagramLineStyle ,
...
public:
	...
	*/
	...
	/* 
		this をNULL状態にします。
	*/
	void setNull(){	*this = CdRessyasyubetsuXColSpec() ;};	
	...
	@return
		属性が同一であれば true 
	*/
	bool isEqualTo( const CdRessyasyubetsuXColSpec& value )const
	{
		bool bRv = false ;
	...
	bool operator==(const CdRessyasyubetsuXColSpec& value )const
...
#endif/*ViewRessyasyubetsu_CdRessyasyubetsuXColSpec_h*/
