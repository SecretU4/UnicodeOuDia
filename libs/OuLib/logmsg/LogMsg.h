...
レベル２で、ログを出力します。このLogMsg() の使い方は、printf()に準じます。
...
@attention
	通常はこの関数の代わりに、 LogMsg() か LogMsgL() を使ってください。
	この関数には、LOGMSG_DISABLED の効果がありません。
...
@param fmt
	...
	続けることができます。
@code
	void LogMsgL( int iLevel , const char* szFmt , ... ) 
@endcode
 */
