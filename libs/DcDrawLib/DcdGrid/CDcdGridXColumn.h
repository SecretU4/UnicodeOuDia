...
*/
/** @file */
#ifndef  CDcdGridXColumn_h
#define  CDcdGridXColumn_h
...
private:
	CDcdGridXColumn( const CDcdGridXColumn& ev ){} ;
	void operator=( CDcdGridXColumn& ev ) {};
...
public:
	...
	CDcdGridXColumn& setAutoColumnSize( bool ev ){
