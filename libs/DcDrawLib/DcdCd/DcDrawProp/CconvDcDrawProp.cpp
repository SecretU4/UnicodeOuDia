...
// ****************************************************************
//	CconvDcDrawProp.cpp
//$Id: CconvDcDrawProp.cpp 316 2016-06-11 14:31:27Z okm $
// ****************************************************************
/** @file */
	...
	CdConnectedString2*	pCdConnectedString )
{
	...
	if ( iRv >= 0 )
	{
		...
		if ( iValue != 0 )
		{
			string aStr = strprintf( "%d" , iValue ) ;
...
string CconvDcDrawProp::CdColorProp_to_string( const CdColorProp& aCdColorProp )
{
	...
	return strprintf( "%08X" , iColorref ) ;
}
...
const char nameLogicalunitWidth[] = "LogicalunitWidth" ;
const char nameColor[] = "Color" ;
const char nameLinestyle[] = "Linestyle" ;
	...
	CdConnectedString2*	pCdConnectedString )
{
	...
	{
		{
			string aStr = aCconvDcDrawProp.CdColorProp_to_string( 
...
string CconvDcDrawProp::CdDcdFreeLineProp_to_string( 
	const CdDcdFreeLineProp& aCdDcdFreeLineProp )
{
	int iRv = 0 ;
	CdConnectedString2	aCdConnectedString2 ;
		...
		const CdConnectedString2*	pCdConnectedString ) 
{
	...
	{
		int iValue = 0 ;
		string	strValue = pCdConnectedString->getValue( nameLogicalunitWidth ) ;
		if ( iRv >= 0 )
		{
			if ( strValue.length() <= 0 )
			{
	...
	{
		CdColorProp	aCdColorProp ;
		string	strValue = pCdConnectedString->getValue( nameColor ) ;
		if ( iRv >= 0 )
		{
			if ( strValue.length() <= 0 )
			{
	...
	{
		CdColorProp	aCdColorProp ;
		string	strValue = pCdConnectedString->getValue( nameLinestyle ) ;
