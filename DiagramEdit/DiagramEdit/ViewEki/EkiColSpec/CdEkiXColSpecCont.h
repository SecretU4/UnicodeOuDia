...
*/
// ****************************************************************
// $Id: CdEkiXColSpecCont.h 179 2014-05-05 13:50:33Z okm $
// ****************************************************************
/** @file */
#pragma once
#ifndef ViewEki_CdEkiXColSpecCont_h
#define ViewEki_CdEkiXColSpecCont_h

#include "ViewEki\EkiColSpec\CdEkiXColSpec.h"
...
/**
@brief
  駅ビューの CWndDcdGridEki において、グリッドX列の
...
public:
	// ********************************
	///@name CdEkiXColSpecCont-属性
	// ********************************
	///@{
	///@}
	// ********************************
	///@name CdEkiXColSpecCont-操作
	// ********************************
	///@{
	/**
	...
	*/
	...
	@return
		...
		戻り値の 
		CdEkiXColSpec::m_eColumnType == 
		ColumnType_NewEki の場合、
		CdEkiXColSpec::m_iEkiIndex は列車本数と
		等しくなります。
	*/
	CdEkiXColSpec ColumnNumberToSpec( 
		int iColumnNumber ) ;
