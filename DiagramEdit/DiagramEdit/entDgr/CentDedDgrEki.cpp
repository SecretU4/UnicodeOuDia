...
// ****************************************************************
//	CentDedDgrEki.cpp
//	$Id: CentDedDgrEki.cpp 94 2012-09-29 12:11:37Z okm $
// ****************************************************************
*/
/** @file */
#include "stdafx.h"
...
//	コンストラクタ
// ********************************
CentDedDgrEki::CentDedDgrEki( const std::string&  strEkimei ,
		bool bIsSyuyoueki , 
		...
		m_iEkikanSaisyouSecKudari( iEkikanSaisyouSecKudari ) ,
		m_iEkikanSaisyouSecNobori( iEkikanSaisyouSecNobori ) , 
...
CentDedDgrEki::CentDedDgrEki() :
		m_bIsSyuyoueki( false ) ,
		m_iEkikanSaisyouSecKudari( 0 ) ,
		m_iEkikanSaisyouSecNobori( 0 ) ,
...
// ********************************
	...
	// ********************************
int CentDedDgrEki::getDgrYZahyouKyori()const
{ 
	int iRv = 0 ;	
	
	if ( m_iEkikanSaisyouSecKudari > 0 && m_iEkikanSaisyouSecNobori > 0 )
	{
		iRv = min( m_iEkikanSaisyouSecKudari , m_iEkikanSaisyouSecNobori );
	}
	else if ( m_iEkikanSaisyouSecKudari > 0 && 
			m_iEkikanSaisyouSecNobori <= 0 )
	{
		iRv = m_iEkikanSaisyouSecKudari ;
	}
	else if ( m_iEkikanSaisyouSecKudari <= 0 && 
			m_iEkikanSaisyouSecNobori > 0 )
	{
		iRv = m_iEkikanSaisyouSecNobori ;
	}
	
	if ( iRv == 0 )
	{
		//	列車設定のない駅間の『ダイヤグラムエンティティY座標』での距離
		iRv = m_iDgrYSizeEkikanDefault ;
	}
	return ( iRv ) ;		
};
