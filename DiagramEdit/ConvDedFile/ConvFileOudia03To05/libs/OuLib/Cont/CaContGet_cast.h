 ...
 * 【概要】
 *   アダプタクラスです。
 *	"IfContGet< ElementType2 >" 型のコンテナオブジェクトを操作対象とし、
 *	操作対象の IfContGet< ElementType2 >" インターフェースを、
 *	IfContGet< ElementType1 >" インターフェースに変換します。
 *
 ...
 * 行うことも可能です
 *
 * ◎  int が格納されている（ IfContGet< int > インターフェースを
 *	サポートした）コンテナを
 * 他のオブジェクトに参照させる場合、参照する側のオブジェクトに
 *  "IfContGet< long > " を渡したい。
 * 
 * 
 * @param ElementType1
 *	キャスト先の要素の型を指定してください。
 *	このクラスは、 "IfContGet< ElementType1 >" インターフェースを
 *	サポートします。
 * @param ElementType2
