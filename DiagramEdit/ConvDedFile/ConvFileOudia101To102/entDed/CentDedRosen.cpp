	...
	, m_CentDedDiaCont( 0 , 0 ) 
{
	...
	CaMui<CentDedEki>( m_pCentDedEkiCont ).insert( value.m_pCentDedEkiCont , 0 , INT_MAX , 0 ) ;
	CaMui<CentDedRessyasyubetsu>( m_pCentDedRessyasyubetsuCont ).insert( value.m_pCentDedRessyasyubetsuCont , 0 , INT_MAX , 0 ) ;
