...
// ********************************
 public:
	 ...
	 *	この列車の列車方向を示します。
	 *	\n
	 *	この値が Ressyahoukou_Null の場合、この『列車』は無効です。
	 *	規定値は Ressyahoukou_Null です。
...
// ********************************
 public:
	 ...
	 */
	CdDedJikoku getEkiJikoku( int iJikokuOrder ) ;
	 ...
	 *	-1 を返します。
	 */
	int findrevJikoku( int iJikokuOrder ) ;
