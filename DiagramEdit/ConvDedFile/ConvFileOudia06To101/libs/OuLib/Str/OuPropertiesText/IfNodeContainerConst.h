...
@brief
	...
	ノードの追加・変更・削除はできません。
*/
class IfNodeContainerConst : public IfContGet< Ou<const CNode> >
{
public:
	// ********************************
	...
	@return
		...
		を返します。
	*/
	virtual string getValue( const string& strName )const = 0 ;
	///@}
...
public:
	...
	/**
	 ...
	 @return
	 	要素の個数を返します。
	*/
	virtual int	sizeInName( const string& strName )const = 0 ;
	/**
	 ...
	 @return
	 	インデクスで指定された要素を返します。
	*/
	virtual Ou<const CNode> getInName( const string& strName , int iInNameIndex )const = 0 ;
