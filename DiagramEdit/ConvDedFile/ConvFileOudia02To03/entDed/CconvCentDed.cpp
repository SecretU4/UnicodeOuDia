...
int CconvCentDed::CentDedEki_To_CdConnectedString( 
...
int CconvCentDed::CentDedEki_From_CdConnectedString( 
...
int CconvCentDed::CentDedRessyasyubetsu_To_CdConnectedString( 
...
int CconvCentDed::CentDedRessyasyubetsu_From_CdConnectedString( 
...
int CconvCentDed::CentDedRessya_To_CdConnectedString( 
...
int CconvCentDed::CentDedRessya_From_CdConnectedString( 
...
int CconvCentDed::CentDedRessyaCont_To_CdConnectedString( 
...
int CconvCentDed::CentDedRessyaCont_From_CdConnectedString( 
...
int CconvCentDed::CentDedDia_To_CdConnectedString( 
...
int CconvCentDed::CentDedDia_From_CdConnectedString( 
...
int CconvCentDed::CentDedRosen_To_CdConnectedString( 
		...
		CdConnectedString2* pCdConnectedString ) 
{
	...
	//3.Ressyasyubetsu[]
	if ( iRv >= 0 ){
		const IfContGet<CentDedRessyasyubetsu*>* pIfContGet = pCentDedRosen->getCentDedRessyasyubetsuContGet() ;
	...
	if ( iRv >= 0 ){
		...
		for ( iDiaIndex = 0 ; iDiaIndex < iDiaCount ; 
			...
			CentDedDia*	pCentDedDia = pCentDedRosen->getCentDedDiaContGet()->get( iDiaIndex ) ;
...
int CconvCentDed::CentDedRosen_From_CdConnectedString( 
