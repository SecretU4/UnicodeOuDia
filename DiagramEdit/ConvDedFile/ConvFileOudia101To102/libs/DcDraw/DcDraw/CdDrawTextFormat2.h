...
*/
/** @file */
#ifndef  CdDrawTextFormat2_h
#define  CdDrawTextFormat2_h
 ...
 * @brief
 * 【概要】
 * 	Win32 の DrawText() APIの uFormat に付与される属性のうち、
 *	描画に関係ない属性も含んだものです。
 *	
 *	このクラスのオブジェクトは、 UINT にキャストすることにより、
 *	直接 DrawText() に渡すことができます。
 */
class CdDrawTextFormat2 : public CdDrawTextFormat
{
// ********************************
//	インナータイプ
// ********************************
...
// ********************************
 public:
	CdDrawTextFormat2( UINT uiFormat ) ;
	CdDrawTextFormat2( 
...
// ********************************
 public:
	...
	CdDrawTextFormat2& setCalcrect( ECalcrect ev );
	EModifystring getModifystring()const ;
	CdDrawTextFormat2& setModifystring( EModifystring ev ) ;
};



#endif /*CdDrawTextFormat2_h*/
