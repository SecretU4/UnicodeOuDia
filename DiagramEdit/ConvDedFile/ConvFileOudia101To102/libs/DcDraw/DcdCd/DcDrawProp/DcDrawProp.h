...
*/
//$Id: DcDrawProp.h 110 2012-09-30 01:24:19Z okm $
#ifndef  DcDraw_DcdCd_DcDrawProp_h
#define  DcDraw_DcdCd_DcDrawProp_h
/**
 @file 
 @brief
...
/**
@brief
　DcDraw での描画動作に必要な属性データのデータタイプを包含します。
	
　この名前空間には、DcDraw での描画動作に必要な属性データを保持するための
単純データクラスが包含されています。

　このクラスは、Windows GDI・MFCなどのプラットフォームに依存しません。
*/
