...
CentDedEkiTrack::CentDedEkiTrack( ETrackType eTrackType , const string& strName )
	: m_eTrackType( eTrackType ) 
	, m_strName( eTrackType == ETrackType_Named ? strName : "" )
{
}

CentDedEkiTrack::CentDedEkiTrack(  const string& strName )
	: m_eTrackType( ETrackType_Named ) 
	, m_strName( strName )
{
}
