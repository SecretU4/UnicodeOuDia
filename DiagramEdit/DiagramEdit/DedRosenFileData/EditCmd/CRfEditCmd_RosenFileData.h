...
/*
// ****************************************************************
//	CRfEditCmd_RosenFileData.h
//	$Id: CRfEditCmd_RosenFileData.h 149 2013-02-02 07:17:32Z okm $
// ****************************************************************
*/
/** @file */
#ifndef  CRfEditCmd_RosenFileData_h
#define  CRfEditCmd_RosenFileData_h
...
/**
 * @brief
  CDedRosenFileData オブジェクト全体を上書きする編集動作です。

 */
class CRfEditCmd_RosenFileData : 
	public CRfEditCmd
{
private:
	// ********************************
	...
	///@{
	/**
	 	新しい CDedRosenFileData の内容を保持します。
	 
	 	execute() は、この値を *pCDedRosenFileData に上書きします。
	 */
	CDedRosenFileData	m_Value ;
	///@}
private:
	// --------------------------------
	///@name 内部データ
...
public:
	...
	/**
	  @param value [in]
	 	新しい CDedRosenFileData の内容を指定してください。
	 */
	CRfEditCmd_RosenFileData( 
		const CDedRosenFileData& value ) : 
		m_Value( value )
	{
	} ;
...
public:
	// ********************************
	///@name CRfEditCmd_RosenFileData-属性
	// ********************************
	///@{
	CDedRosenFileData	getValue()const{	return m_Value ;};
	CRfEditCmd_RosenFileData& setValue( 
		const CDedRosenFileData& value )
	{
		m_Value = value ;
		return *this ;
...
#endif /*CRfEditCmd_RosenFileData_h*/
