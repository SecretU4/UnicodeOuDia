...
void CTreeCtrlContextMenu::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	CPoint	pointMenu ;
	//	キー操作によるコンテキストメニュー
	//	この場合は、コンテキストメニューの対象は
	//	フォーカスのあるアイテムとなります。
	//	また、メニュー表示位置は 対象のアイテムの右下です。
	...
	//htItem = コンテキストメニューの対象となるツリーアイテム
	//	(NULLの場合、コンテキストメニューの表示はできません）
	//pointMenu=コンテキストメニューの表示位置(スクリーン座標)
