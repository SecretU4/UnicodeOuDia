...
int CconvCdDedDispProp_03::toCdConnectedString( 
		...
		CdConnectedString2* pCdConnectedString ) 
{
	...
	if ( iRv >= 0 )
	{
		pCdConnectedString->setItem( nameDiaHaikeiColor , 
...
int CconvCdDedDispProp_03::fromCdConnectedString( 
