	...
	const CdDcdZone& value ) 
{
	...
	//@name 操作
	// ********************************
DcdPos CconvDcdPosOnZone_DcdZone::Zone1PosToZone2( DcdPos posZone1Pos )const 
{
	DcdPos posZone2Pos = 0 ; 
	if ( m_Zone1.getSize() !=  0 ) 
	{
		posZone2Pos = ( posZone1Pos * m_Zone2.getSize() /  m_Zone1.getSize() ) 
			- ( m_Zone1.getPos() * m_Zone2.getSize() /  m_Zone1.getSize() ) 
			+  m_Zone2.getPos()  ;
	}
	return ( posZone2Pos ) ;
}

DcdPos CconvDcdPosOnZone_DcdZone::Zone1PosFromZone2( DcdPos posZone2Pos )const 
{

	DcdPos posZone1Pos = 0 ; 
	if ( m_Zone2.getSize() != 0 )
	{
		posZone1Pos = ( posZone2Pos * m_Zone1.getSize() / m_Zone2.getSize() ) 
			- ( m_Zone2.getPos() * m_Zone1.getSize() / m_Zone2.getSize() ) 
			+ m_Zone1.getPos() ;
	}
	return posZone1Pos ; 
