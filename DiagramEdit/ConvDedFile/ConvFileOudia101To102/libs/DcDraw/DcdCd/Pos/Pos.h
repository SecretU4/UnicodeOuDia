...
*/
//$Id: Pos.h 110 2012-09-30 01:24:19Z okm $
#ifndef  DcDraw_DcdCd_Pos_h
#define  DcDraw_DcdCd_Pos_h
/**
 @file 
 @brief
...
/**
@brief
　座標を保持するデータ型と、座標計算を行うクラスを包含します。

　描画座標上での位置・大きさを保持するデータ型を包含します。
　また、座標に関する演算を行うクラスも包含します。
