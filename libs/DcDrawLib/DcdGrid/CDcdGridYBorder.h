...
*/
/** @file CDcdGridYBorder.h */
//$Id: CDcdGridYBorder.h 296 2016-06-11 05:40:21Z okm $
//////////////////////////////////////////////////////////////////////

#ifndef CDcdGridYBorder_h
#define CDcdGridYBorder_h
...
private:
	...
	/**
		...
		通常は、 CDcdGrid::OnCreateYColumn() がインスタンスを生成・登録し、
		 CDcdGrid::OnDeleteYColumn() がインスタンスを登録解除・破棄します。
		
		デフォルトの  CDcdGrid::OnCreateYColumn() の実装は、
	...
	/**
		真なら、 m_pIfDcDraw の getItemSize() が返す
...
public:
	 ...
	 */
	CDcdGridYBorder();
	virtual ~CDcdGridYBorder(){};
private:
	CDcdGridYBorder( const CDcdGridYBorder& ev ){} ;
	void operator=( CDcdGridYBorder& ev ) {};
...
public:
	...
	CDcdGridYBorder& setColumnBorderSize( DcdSize ev ){
	...
	CDcdGridYBorder& setAutoColumnBorderSize( bool ev ){
