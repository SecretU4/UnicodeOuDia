...
*/
// ****************************************************************
//	$Id: CPropEditUI_Ekijikoku.h 357 2016-08-18 16:59:16Z okm $
// ****************************************************************

/** @file */
#ifndef  ViewJikokuhyou_CPropEditUi_EkiJikoku_h
#define  ViewJikokuhyou_CPropEditUi_EkiJikoku_h
#pragma once
...
// ********************************
/**
	CPropEditUi_Ekijikoku で編集するプロパティの UIDATA 構造体です。
*/
struct UIDATA_EkiJikoku
{
	/**
	 駅扱
	 -	 0: 運行なし
	...
	*/
	...
	/**
	 着時刻
	*/
	string strChakujikoku ;
	
	/**
	 strChakujikoku の編集の有効・無効。
	 true なら有効です 
	*/
	bool bChakujikokuIsEnable ;

	/**
	 発時刻
	*/
	string strHatsujikoku ;
	
	/**
	 strHatsujikoku の編集の有効・無効。
	 true なら有効です 
	*/
	bool bHatsujikokuIsEnable ;
	...
	*/
	...
	UIDATA_EkiJikoku() 
		: iEkiatsukai( 0 )	//: 運行なし
		, bChakujikokuIsEnable( true )
		, bHatsujikokuIsEnable( true )
		, bModifyHatsujikoku( true )
	{
	}
};
...
*/
class CPropEditUi_EkiJikoku : public CPropEditUi2<UIDATA_EkiJikoku>
{
...
public:
	...
	///@{
	/// 着時刻の入力が正しくありません
	static const char* const ERRMSG_INVALID_CHAKUJIKOKU ;

	/// 発時刻の入力が正しくありません
	static const char* const ERRMSG_INVALID_HATSUJIKOKU ;
	///@}
...
#endif /*ViewJikokuhyou_CPropEditUi_EkiJikoku_h*/
