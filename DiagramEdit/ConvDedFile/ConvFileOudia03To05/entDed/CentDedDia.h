...
// ********************************
 public:
	...
	const CentDedRessyaCont* getpCentDedRessyaCont( 
	 ...
	 *	-	上り : 	Ressyahoukou_Nobori 
	 */
	const IfContGet< const CentDedRessya* >* getCentDedRessyaContGet( 
			ERessyahoukou eRessyahoukou )const
	{
		return ((const CentDedRessyaCont*)m_CentDedRessyaCont[ eRessyahoukou ])->getIfContGet() ;
	};
