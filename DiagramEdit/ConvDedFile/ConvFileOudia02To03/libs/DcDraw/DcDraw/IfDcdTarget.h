...
class IfDcdTarget
{
 public:
	...
	*/
	 ...
	 */
	virtual HFONT	CreateFont(  const CdFontProp& aCdFontProp ) = 0 ;
	...
	*	関数呼出元は、ハンドルを解放してはいけません。
	*/
	virtual HPEN	CreatePen(  const CdPenProp& aCdPenProp ) = 0 ;
	...
	*	関数呼出元は、ハンドルを解放してはいけません。
	*/
	virtual HBRUSH	CreateBrush(  const CdBrushProp& aCdBrushProp ) = 0 ;
