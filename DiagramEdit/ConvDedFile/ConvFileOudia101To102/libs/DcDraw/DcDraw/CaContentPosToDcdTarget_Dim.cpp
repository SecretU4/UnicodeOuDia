...
/*
// ****************************************************************
// $Id: CaContentPosToDcdTarget_Dim.cpp 110 2012-09-30 01:24:19Z okm $
// ****************************************************************
*/
#include "stdafx.h"
...
DcdSize	CaContentPosToDcdTarget_Dim::getContentSize()const 
{
	...
	// ********************************
	//@name TargetPosPerContent-TargetPosPerContent,ContentSize 取得・設定
	// ********************************
		...
		const CdDcdZone& zoneTarget , IfDcdTarget* pIfDcdTarget ) 
{
	...
	// ********************************
	//@name CconvContentPosToTarget_Dim-関連
	// ********************************
