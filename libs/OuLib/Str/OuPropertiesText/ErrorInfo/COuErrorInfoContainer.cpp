...
*/
// ****************************************************************
// $Id: COuErrorInfoContainer.cpp 343 2016-08-07 12:13:10Z okm $
// ****************************************************************
...
COuErrorInfoContainer::COuErrorInfoContainer()
{
	...
	//@name 関連
	// ********************************
Mui<COuErrorInfo>* COuErrorInfoContainer::getCOuErrorInfoCont()
{
	return this ;
}
const Mui<COuErrorInfo>* COuErrorInfoContainer::getCOuErrorInfoCont()const
{
	return this ;
};
...
int COuErrorInfoContainer::fromOuErrorInfoText( const std::string& strOuErrorInfoText ) 
{
	int iRv = 0 ;
	this->erase( 0 , INT_MAX ) ;
	deque<string> contstrLines = OuLib::Str::splitc< deque< string > >( '\n' , strOuErrorInfoText ) ;
	for ( int idxLine = 0 ; 
