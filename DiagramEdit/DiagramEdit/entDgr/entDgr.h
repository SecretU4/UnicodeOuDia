...
// ****************************************************************
//	entDgr.h
//	$Id: entDgr.h 261 2016-01-23 03:59:53Z okm $
// ****************************************************************
*/
/** @file */
#ifndef  entDgr_h
...
　時刻データをもとに、ダイヤグラムを構成する要素の座標を算出します。

　クラスは、 CentDedDgrDia をルートとした木構造を持ちます。

　この名前空間では、ダイヤグラムの各要素の座標を、描画するデバイス
(例：ウインドウ,プリンタ)に依存しない形式で保持します。

　これらの座標を、デバイス固有の形式に変換するのは、 CDcdDiagram , 
CDcdDiagram2 の責務です。
*/
namespace entDgr{
} //namespace entDgr
