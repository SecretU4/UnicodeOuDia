...
*/
// ****************************************************************
// $Id: COuErrorInfoContainer.h 10 2012-08-26 09:48:47Z okm $
// ****************************************************************
/** @file */
...
*/
class COuErrorInfoContainer : public CCont_deque<COuErrorInfo>
{
public:
	// ********************************
	//	コンストラクタ
	...
	@return
		...
		取得・設定するためのインターフェース。
	*/
	IfCont<COuErrorInfo>* getCOuErrorInfoCont();
	const IfCont<COuErrorInfo>* getCOuErrorInfoCont()const;
	///@}
	// ********************************
	///@name 操作
	// ********************************
