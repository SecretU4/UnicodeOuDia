...
// ****************************************************************
/**
	CConverter_WinGdi の関数の宣言です。
	現在は、指定なし(非仮想・非static メンバ関数) としています。
*/
...
public:
	...
	*/
	...
	/**
		CdDrawTextFormat オブジェクトの属性をもとに、
		CdWinGdi_DrawText_Format オブジェクトを生成します。
		この値は、 Win32 の DrawText() の uiFlags パラメータに
		渡すことができます。
