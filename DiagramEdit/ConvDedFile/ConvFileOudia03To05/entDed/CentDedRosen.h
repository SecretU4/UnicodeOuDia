 ...
 public:
	...
	/**
	 ...
	 @attention
		...
		CaCont::insert() を使用することもできます。
	@code
		CaCont<CentDedEki>	aCaCont( aCentDedRosen().getCentDedEkiCont() ) ; 
	...
	*/
	...
	const IfContGet<const CentDedRessyasyubetsu*>* 
		getCentDedRessyasyubetsuContGet()const
	{
		return ((const CentDedRessyasyubetsuCont*)m_pCentDedRessyasyubetsuCont)->getIfContGet() ;
	};
	...
	const IfContGet<const CentDedDia*>* getCentDedDiaContGet()const
	{
		return m_CentDedDiaCont.getIfContGet() ;
	};
	///@}
