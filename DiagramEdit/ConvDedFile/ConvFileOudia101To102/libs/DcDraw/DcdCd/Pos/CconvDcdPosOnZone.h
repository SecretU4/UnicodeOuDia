...
// ****************************************************************
//	CconvDcdPosOnZone.h
// $Id: CconvDcdPosOnZone.h 10 2012-08-26 09:48:47Z okm $
// ****************************************************************
*/
/** @file */
...
public:
	...
	/**
	 ...
	 @return
		変換後の値を返します。
	 */
	virtual CdDcdZone Zone1ToZone2( const CdDcdZone& value )const =0;
	...
	/**
	 ...
	 @return
		変換後の値を返します。
	 */
	virtual CdDcdZone Zone1FromZone2( const CdDcdZone& value )const =0;
	///@}
};
