 ...
 public:
	...
	///@{
	 private:
		 ...
		 *	文字列要素に含まれる部分文字列。
		 */
		 std::string m_strBubunMojiretsu ;
	...
	///@{
	public:
		std::string getBubunMojiretsu()const{ return m_strBubunMojiretsu ;};
		CMojiretsuyouso& setBubunMojiretsu( const std::string& value ){
...
///@{
 public:
	 ...
	 *	テキストの文字の色を指定してください。
	 * @param pCMojiretsuyousoPlaceCont [in]
...
// ********************************
 public:
	...
	virtual CDcdFillRectangleTextV2& setTextColor( const CdColorProp& value ){
