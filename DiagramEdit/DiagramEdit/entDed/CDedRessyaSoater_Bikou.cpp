...
/*
// ****************************************************************
//	CDedRessyaSoater_Bikou.cpp
// $Id: CDedRessyaSoater_Bikou.cpp 378 2016-11-16 21:10:54Z okm $
// ****************************************************************
*/
/** @file */
#include "stdafx.h"
...
#include "CDedRessyaSoater_Bikou.h"

namespace entDed{

// ****************************************************************
//	CdRessyaForSort_Bikou
// ****************************************************************
	/**
		Mu<CentDedRessyaCont*> 内の列車(のIndex)を、
		列車種別で比較する関数オブジェクトです。
	*/
	class CentDedRessyaIdxCompare_Bikou
	{
		// ********************************
		///@name 関連
		// ********************************
	...
	public:
		...
		*/
			...
			int idxright )
		{
			...
			//	- 備考が辞書順で早い方が先。
			// --------------------------------
			if ( left.getBikou() < right.getBikou() )
			{
				return true ;
			}
			else if ( left.getBikou() > right.getBikou() )
			{
				return false ;
			}
...
// ****************************************************************
	...
	//	コンストラクタ
	// ********************************
CDedRessyaSoater_Bikou::CDedRessyaSoater_Bikou() 
{
}
...
CDedRessyaSoater_Bikou::~CDedRessyaSoater_Bikou() 
{
	...
	// --------------------------------
void CDedRessyaSoater_Bikou::sortRessyaIndex( 
