...
*/
//$Id: FrameLeftPane.h 76 2012-09-08 06:34:12Z okm $
/**
 @file 
 @brief
	名前空間の関数群・クラス群のすべてをインクルードします。
*/
#ifndef  FrameLeftPane_H
#define  FrameLeftPane_H

namespace OuMfc{

/**
@brief
	MDIFrameLeftPane アプリケーション作成のためのクラスを収録します。
