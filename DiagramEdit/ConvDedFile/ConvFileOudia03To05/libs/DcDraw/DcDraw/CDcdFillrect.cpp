...
//	コンストラクタ
// ********************************
CDcdFillrect::CDcdFillrect( const CdBrushProp& aCdBrushProp ) 
	: m_CdBrushProp( aCdBrushProp )
{
}
CDcdFillrect::CDcdFillrect() 
{
}
CDcdFillrect::~CDcdFillrect() 
{
...
bool CDcdFillrect::DcDraw( IfDcdTarget* pIfDcdTarget ) 
{
	...
	if ( iRv >= 0 ){
		...
		FillRect( pIfDcdTarget->getHdc() , &LRect , hBrush ) ;
...
bool CDcdFillrect::getItemSize( IfDcdTarget* pIfDcdTarget , 
