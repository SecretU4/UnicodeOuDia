...
// ****************************************************************
//	Mui.h
// $Id: Mui.h 10 2012-08-26 09:48:47Z okm $
// ****************************************************************
*/
/** @file */
#ifndef  Mu_Mui_h
...
/**
 @brief
	Mui(Multi object Insertable) は、 ElementType で指定した型の要素を
	複数保持するコンテナを操作するインターフェースです。
	このインターフェースでは、コンテナへの要素の追加・削除ができます。
*/
template < class ElementType > class Mui : 
	public Mu< ElementType >
{
 public:
	/**
	 *	このコンテナに格納されている要素の型。
