...
*/
// ****************************************************************
// $Id: CdEkiYColSpecCont.h 179 2014-05-05 13:50:33Z okm $
// ****************************************************************
/** @file */
#pragma once
#ifndef ViewEki_CdEkiYColSpecCont_h
#define ViewEki_CdEkiYColSpecCont_h

#include "ViewEki\EkiColSpec\CdEkiYColSpec.h"
...
/**
@brief
  駅ビューの CWndDcdGridEki において、グリッドY列の
...
public:
	// ********************************
	///@name CdEkiYColSpecCont-属性
	// ********************************
	///@{
	int getEkiCount()const;
	///@}
	// ********************************
	///@name CdEkiYColSpecCont-操作
	// ********************************
	///@{
	/**
	...
	*/
	...
	@return
		...
		戻り値の 
		CdEkiYColSpec::m_eColumnType == 
		ColumnType_NewEki の場合、
		CdEkiYColSpec::m_iEkiIndex は駅数と
		等しくなります。
	*/
	CdEkiYColSpec ColumnNumberToSpec( 
		int iColumnNumber ) ;
