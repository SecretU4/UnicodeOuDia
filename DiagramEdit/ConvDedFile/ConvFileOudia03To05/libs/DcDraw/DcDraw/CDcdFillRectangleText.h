...
/*
// ****************************************************************
//	CDcdFillRectangleText.h
// ****************************************************************
*/
/** @file */
#ifndef  CDcdFillRectangleText_h
#define  CDcdFillRectangleText_h
#include <string>
using namespace std ;
#include "str/tstring.h"

#include "CDcdFillrect.h"
 ...
 *
 * @note
 *	CDcdRectangleTextとCDcdFillRectangleText の違いは、ペンの属性が
 *	SOLIDでない場合に明らかになります。
 *	このとき、 CDcdRectangleText では、枠線の描画されない部分はDCの背景色と
 *	なりますが、 CDcdFillRectangleText の場合は、枠線の描画されない部分を
 *	透過モードとします（つまり、背景ブラシが反映されます）。
 */
class CDcdFillRectangleText : public IfDcDraw
{
// --------------------------------
///@name	包含
// --------------------------------
...
// ********************************
 public:
	...
	virtual CDcdFillRectangleText& setText( const tstring& ev ){	
	...
	virtual CDcdFillRectangleText& setCdDrawTextProp( 
	...
	virtual CDcdFillRectangleText&  setExtent( const tstring& ev ){
	...
	virtual CDcdFillRectangleText& setLinesExtent( int ev ){
	...
	virtual CDcdFillRectangleText& setCdBrushProp( const CdBrushProp& ev ){
